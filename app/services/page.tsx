  ...
  return (
    <Layout>
      ...
      <section className="relative py-24 bg-gradient-to-b from-card/30 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="p-12 rounded-2xl border border-primary/20 bg-card/50 backdrop-blur-sm animate-pulse-glow">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Need a Custom Dataset?</h2>
              <p className="text-lg text-muted-foreground mb-8">
                Let&apos;s discuss how we can provide the exact medical data your AI project needs
              </p>
              <Button asChild>
                <Link href="/contact">Request a Dataset</Link>
              </Button>
            </div>
          </div>
        </div>
